...
- **Outstanding items:** Awaiting marketing assignment on the FR template translation request (`docs/marketing/chatwoot_template_localization_request_2025-10-08.md`) and product confirmation for the 2025-10-16 dry run (`docs/runbooks/operator_training_agenda.md`). Support will follow up Tue/Thu per localization cadence and send invites once staging access is confirmed.
