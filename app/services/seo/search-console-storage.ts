 ...
 */
export async function getTopQueriesByDate(date: Date = new Date(), limit: number = 10) {
 ...
 */
export async function getTopLandingPagesByDate(date: Date = new Date(), limit: number = 10) {
  const dateOnly = new Date(date);
  dateOnly.setHours(0, 0, 0, 0);
