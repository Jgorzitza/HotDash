...
export function calculateSelfGradeAverage(grades: {
  ...
  const sum = grades.progress + grades.evidence + grades.alignment + 
              grades.toolDiscipline + grades.communication;
