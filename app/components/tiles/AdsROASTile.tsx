  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "var(--occ-space-4)", height: "100%" }}>
      <div>
        ...
        <div style={{ fontSize: "var(--occ-font-size-3xl)", fontWeight: "var(--occ-font-weight-bold)", color: data.roas >= 4 ? "var(--occ-text-success)" : data.roas >= 2 ? "var(--occ-text-warning)" : "var(--occ-text-critical)" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "var(--occ-space-3)" }}>
        <div>
          <div style={{ fontSize: "var(--occ-font-size-xs)", color: "var(--occ-text-secondary)" }}>Spend</div>
          <div style={{ fontSize: "var(--occ-font-size-md)", fontWeight: "600" }}>${data.totalSpend.toLocaleString()}</div>
        </div>
        <div>
          <div style={{ fontSize: "var(--occ-font-size-xs)", color: "var(--occ-text-secondary)" }}>Revenue</div>
          <div style={{ fontSize: "var(--occ-font-size-md)", fontWeight: "600" }}>${data.totalRevenue.toLocaleString()}</div>
        </div>
      </div>

      <div style={{ padding: "var(--occ-space-3)", background: "var(--occ-bg-secondary)", borderRadius: "var(--occ-radius-md)", borderLeft: "3px solid var(--occ-border-success)" }}>
