...
import type { PerformanceAnalysisResult, OptimizationResult } from '~/lib/growth-engine/performance-analysis';
...
type ViewMode = 'overview' | 'analysis' | 'optimization' | 'recommendations' | 'monitoring';
    ...
    return (
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--occ-space-2)' }}>
          ...
          <div>
            <h3 style={{ margin: 0, color: 'var(--occ-color-error)' }}>Error loading performance data</h3>
    ...
    <div style={{ padding: 'var(--occ-space-4)' }}>
      ...
      <div style={{ marginBottom: 'var(--occ-space-4)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 'var(--occ-space-2)' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--occ-space-2)' }}>
            <label style={{ display: 'flex', alignItems: 'center', gap: 'var(--occ-space-1)', fontSize: 'var(--occ-font-size-sm)' }}>
              <input
                type="checkbox"
                checked={autoRefresh}
        ...
        <p style={{ 
          ...
          Advanced performance analysis and optimization for Growth Engine infrastructure
        </p>
      </div>
      ...
      {/* Content */}
      {viewMode === 'overview' && analysis && <OverviewView analysis={analysis} optimization={optimization} />}
      {viewMode === 'analysis' && analysis && <AnalysisView analysis={analysis} />}
      {viewMode === 'optimization' && optimization && <OptimizationView optimization={optimization} />}
      {viewMode === 'recommendations' && analysis && <RecommendationsView analysis={analysis} />}
      {viewMode === 'monitoring' && analysis && <MonitoringView analysis={analysis} />}
    </div>
  );
}
...
function OverviewView({ 
  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 'var(--occ-space-4)' }}>
        <h3 style={{ margin: 0, marginBottom: 'var(--occ-space-3)' }}>Overall Performance</h3>
        <div style={{
          display: 'grid',
      ...
      <div style={{ marginBottom: 'var(--occ-space-4)' }}>
        <h3 style={{ margin: 0, marginBottom: 'var(--occ-space-3)' }}>Category Performance</h3>
        <div style={{
          display: 'grid',
          ...
          {Object.entries(analysis.categories).map(([category, data]) => (
            <div key={category} style={{
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--occ-space-2)', fontSize: 'var(--occ-font-size-sm)' }}>
                <div>
                  <div style={{ color: 'var(--occ-text-secondary)' }}>Response Time</div>
                  <div style={{ fontWeight: 'var(--occ-font-weight-medium)' }}>
                    {data.metrics.responseTime.toFixed(0)}ms
                  </div>
                </div>
                <div>
                  <div style={{ color: 'var(--occ-text-secondary)' }}>Throughput</div>
                  <div style={{ fontWeight: 'var(--occ-font-weight-medium)' }}>
                    {data.metrics.throughput.toFixed(0)}/s
                  </div>
                </div>
                <div>
                  <div style={{ color: 'var(--occ-text-secondary)' }}>Error Rate</div>
                  <div style={{ fontWeight: 'var(--occ-font-weight-medium)' }}>
                    {data.metrics.errorRate.toFixed(1)}%
                  </div>
                </div>
                <div>
                  <div style={{ color: 'var(--occ-text-secondary)' }}>Resource Usage</div>
                  <div style={{ fontWeight: 'var(--occ-font-weight-medium)' }}>
      ...
      {analysis.criticalIssues.length > 0 && (
        <div>
          <h3 style={{ margin: 0, marginBottom: 'var(--occ-space-3)' }}>Critical Issues</h3>
          <div style={{ display: 'grid', gap: 'var(--occ-space-2)' }}>
            {analysis.criticalIssues.map((issue) => (
              <div key={issue.id} style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: 'var(--occ-space-2)' }}>
                  <div>
                ...
                <div>
                  ...
                  <ul style={{ margin: 0, paddingLeft: 'var(--occ-space-4)', fontSize: 'var(--occ-font-size-sm)' }}>
...
function AnalysisView({ analysis }: { analysis: PerformanceAnalysisResult }) {
  return (
    <div>
      <h3 style={{ margin: 0, marginBottom: 'var(--occ-space-3)' }}>Detailed Performance Analysis</h3>
      
      {/* Performance Trends */}
      {analysis.performanceTrends.length > 0 && (
        <div style={{ marginBottom: 'var(--occ-space-4)' }}>
          <h4 style={{ margin: 0, marginBottom: 'var(--occ-space-2)' }}>Performance Trends</h4>
          <div style={{ display: 'grid', gap: 'var(--occ-space-2)' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <div style={{ 
                      fontSize: 'var(--occ-font-size-lg)',
                      fontWeight: 'var(--occ-font-weight-semibold)',
                      color: trend.change > 0 ? 'var(--occ-color-success)' : 'var(--occ-color-error)'
                    }}>
      ...
      {/* Category Details */}
      <div>
        <h4 style={{ margin: 0, marginBottom: 'var(--occ-space-2)' }}>Category Details</h4>
        <div style={{ display: 'grid', gap: 'var(--occ-space-3)' }}>
          {Object.entries(analysis.categories).map(([category, data]) => (
            <div key={category} style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 'var(--occ-space-3)' }}>
                ...
                <div style={{ 
                  fontSize: 'var(--occ-font-size-2xl)',
                  fontWeight: 'var(--occ-font-weight-bold)',
                  color: data.score >= 80 ? 'var(--occ-color-success)' : 
                         data.score >= 60 ? 'var(--occ-color-warning)' : 'var(--occ-color-error)'
                }}>
                  {data.score}
                </div>
              </div>
              ...
              <div style={{ 
                ...
                <MetricCard title="Response Time" value={`${data.metrics.responseTime.toFixed(0)}ms`} />
                <MetricCard title="Throughput" value={`${data.metrics.throughput.toFixed(0)}/s`} />
                <MetricCard title="Error Rate" value={`${data.metrics.errorRate.toFixed(1)}%`} />
                <MetricCard title="Resource Usage" value={`${data.metrics.resourceUsage.toFixed(0)}%`} />
              </div>

              {/* Bottlenecks */}
              {data.bottlenecks.length > 0 && (
                <div>
                  <h6 style={{ margin: 0, marginBottom: 'var(--occ-space-2)' }}>Bottlenecks</h6>
                  <div style={{ display: 'grid', gap: 'var(--occ-space-2)' }}>
                    {data.bottlenecks.map((bottleneck) => (
                      <div key={bottleneck.id} style={{
                        padding: 'var(--occ-space-2)',
                        border: '1px solid var(--occ-border-warning)',
                        borderRadius: 'var(--occ-radius-sm)',
                        backgroundColor: 'var(--occ-bg-warning-subdued)'
                      }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: 'var(--occ-space-1)' }}>
                          <div>
                            <div style={{ fontWeight: 'var(--occ-font-weight-medium)' }}>
                              {bottleneck.description}
                            </div>
                            <div style={{ fontSize: 'var(--occ-font-size-sm)', color: 'var(--occ-text-secondary)' }}>
                              Impact: {bottleneck.impact}% • Solution: {bottleneck.solution}
                            </div>
                          </div>
                          <span style={{
                            padding: 'var(--occ-space-1) var(--occ-space-2)',
                            borderRadius: 'var(--occ-radius-sm)',
                            fontSize: 'var(--occ-font-size-xs)',
                            backgroundColor: bottleneck.severity === 'critical' ? 'var(--occ-bg-error)' : 'var(--occ-bg-warning)',
                            color: bottleneck.severity === 'critical' ? 'var(--occ-color-error)' : 'var(--occ-color-warning)',
                            fontWeight: 'var(--occ-font-weight-medium)'
                          }}>
              ...
              {data.optimizations.length > 0 && (
                <div>
                  <h6 style={{ margin: 0, marginBottom: 'var(--occ-space-2)' }}>Optimizations</h6>
                  <ul style={{ margin: 0, paddingLeft: 'var(--occ-space-4)', fontSize: 'var(--occ-font-size-sm)' }}>
...
function OptimizationView({ optimization }: { optimization: OptimizerResult }) {
  return (
    <div>
      <h3 style={{ margin: 0, marginBottom: 'var(--occ-space-3)' }}>Optimization Results</h3>
      ...
      <div style={{ marginBottom: 'var(--occ-space-4)' }}>
        <div style={{
          ...
          <div style={{ 
            ...
            {optimization.success ? 'Optimization Successful' : 'Optimization Failed'}
          </div>
          <div style={{ 
            fontSize: 'var(--occ-font-size-sm)',
            color: 'var(--occ-text-secondary)'
      ...
      {/* Performance Gains */}
      <div style={{ marginBottom: 'var(--occ-space-4)' }}>
        <h4 style={{ margin: 0, marginBottom: 'var(--occ-space-2)' }}>Performance Gains</h4>
        <div style={{
          display: 'grid',
          gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))',
          gap: 'var(--occ-space-3)'
        }}>
          <MetricCard title="Overall" value={`+${optimization.performanceGains.overall}%`} />
          <MetricCard title="Database" value={`+${optimization.performanceGains.database}%`} />
          <MetricCard title="API" value={`+${optimization.performanceGains.api}%`} />
          <MetricCard title="Frontend" value={`+${optimization.performanceGains.frontend}%`} />
          <MetricCard title="Caching" value={`+${optimization.performanceGains.caching}%`} />
          <MetricCard title="Analytics" value={`+${optimization.performanceGains.analytics}%`} />
        </div>
      </div>
      ...
      {optimization.optimizationsApplied.length > 0 && (
        <div style={{ marginBottom: 'var(--occ-space-4)' }}>
          <h4 style={{ margin: 0, marginBottom: 'var(--occ-space-2)' }}>Applied Optimizations</h4>
          <div style={{ display: 'grid', gap: 'var(--occ-space-2)' }}>
      ...
      {optimization.evidence.optimizationLog.length > 0 && (
        <div>
          <h4 style={{ margin: 0, marginBottom: 'var(--occ-space-2)' }}>Optimization Log</h4>
          <div style={{
            padding: 'var(--occ-space-3)',
            border: '1px solid var(--occ-border-default)',
            borderRadius: 'var(--occ-radius-md)',
...
function RecommendationsView({ analysis }: { analysis: PerformanceAnalysisResult }) {
  return (
    <div>
      <h3 style={{ margin: 0, marginBottom: 'var(--occ-space-3)' }}>Optimization Recommendations</h3>
      ...
      <div style={{ display: 'grid', gap: 'var(--occ-space-3)' }}>
        {analysis.recommendations.map((recommendation) => (
          <div key={recommendation.id} style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: 'var(--occ-space-3)' }}>
              ...
              <div style={{ display: 'flex', gap: 'var(--occ-space-2)' }}>
                <span style={{
                  ...
                  borderRadius: 'var(--occ-radius-sm)',
                  fontSize: 'var(--occ-font-size-xs)',
                  backgroundColor: recommendation.priority === 'critical' ? 'var(--occ-bg-error)' :
                                 recommendation.priority === 'high' ? 'var(--occ-bg-warning)' : 'var(--occ-bg-info)',
                  color: recommendation.priority === 'critical' ? 'var(--occ-color-error)' :
                         recommendation.priority === 'high' ? 'var(--occ-color-warning)' : 'var(--occ-color-info)',
                  fontWeight: 'var(--occ-font-weight-medium)'
                }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 'var(--occ-space-3)', marginBottom: 'var(--occ-space-3)' }}>
              <div>
                <div style={{ fontSize: 'var(--occ-font-size-sm)', fontWeight: 'var(--occ-font-weight-medium)', marginBottom: 'var(--occ-space-1)' }}>
                  Expected Impact
                </div>
                <div style={{ fontSize: 'var(--occ-font-size-lg)', fontWeight: 'var(--occ-font-weight-semibold)', color: 'var(--occ-color-success)' }}>
            ...
            <div>
              ...
              <ol style={{ margin: 0, paddingLeft: 'var(--occ-space-4)', fontSize: 'var(--occ-font-size-sm)' }}>
...
function MonitoringView({ analysis }: { analysis: PerformanceAnalysisResult }) {
  return (
    <div>
      <h3 style={{ margin: 0, marginBottom: 'var(--occ-space-3)' }}>Real-time Monitoring</h3>
