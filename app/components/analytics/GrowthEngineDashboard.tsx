      ...
      <div style={{ marginBottom: "var(--occ-space-4)" }}>
        ...
        >
          {analytics.phases.map((phase) => {
            const phaseInsight = analytics.insights.phaseProgress.find(
    ...
    <div>
      ...
      <div style={{ display: "grid", gap: "var(--occ-space-3)" }}>
        {analytics.phases.map((phase) => {
          ...
          const phaseActions = analytics.actions.filter(
            (action) => action.phase === phase.phase,
          );
                        ...
                        >
                          ...
                          <div style={{ textAlign: "right" }}>
                            <div
                              style={{
                                color:
                                  action.actualROI && action.actualROI > 3
                                    ? "var(--occ-color-success)"
        ...
        >
          ...
          <tbody>
            {analytics.actions.map((action) => (
              <tr
                key={action.actionId}
                style={{ borderBottom: "1px solid var(--occ-border-subdued)" }}
              >
                ...
                <td
                  style={{ padding: "var(--occ-space-3)", textAlign: "right" }}
                >
  ...
  return (
    <div>
                ...
                <div>
                  ...
                  <ul style={{ margin: 0, paddingLeft: "var(--occ-space-4)" }}>
                    {effectiveness.recommendations.map((rec, index) => (
                      <li
                        key={index}
                        style={{ fontSize: "var(--occ-font-size-sm)" }}
                      >
                        {rec}
                      </li>
                    ))}
      ...
      <div style={{ marginBottom: "var(--occ-space-4)" }}>
        ...
        >
          <ul style={{ margin: 0, paddingLeft: "var(--occ-space-4)" }}>
            {analytics.insights.optimizationOpportunities.map(
              (opportunity, index) => (
