          ...
          >
            <thead>
              <tr style={{ backgroundColor: "var(--occ-bg-subdued)" }}>
                <th
                  style={{ padding: "var(--occ-space-3)", textAlign: "left" }}
                >
                  Action
                </th>
                <th
                ...
                <th
                  style={{ padding: "var(--occ-space-3)", textAlign: "center" }}
                >
                  Actions
                </th>
              </tr>
...
function getSortedActions(
  ...
  return [...actions].sort((a, b) => {
    switch (sortBy) {
      ...
      case "conversions":
        return (
          b.actualImpact["28d"].conversions - a.actualImpact["28d"].conversions
        );
      case "confidence":
