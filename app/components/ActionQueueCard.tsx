...
export function ActionQueueCard({
   ...
   */
  const handleActionLinkClick = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
    ...
    <div className="action-queue-card" style={{ background: getActionTypeColor(action.actionType) }}>
        ...
        {hasAttribution && (
          <div className="action-queue-card__attribution">
            ...
            <div className="action-queue-card__attribution-windows">
              ...
              {action.realizedRevenue14d !== undefined && (
                <span className="action-queue-card__metric-value action-queue-card__metric-value--small">
                  14d: ${action.realizedRevenue14d.toFixed(2)}
                </span>
              )}
              {action.realizedRevenue28d !== undefined && (
                <span className="action-queue-card__metric-value action-queue-card__metric-value--small">
      ...
      <div className="action-queue-card__actions">
        <a
          ...
          className="action-queue-card__link"
          aria-label={`View ${action.title} (tracked for attribution)`}
        >
          View Action Target →
        </a>
          ...
          <div className="action-queue-card__approval-actions">
            {onApprove && (
              <button
                ...
                className="action-queue-card__button action-queue-card__button--primary"
              >
                Approve
              </button>
            )}
            {onReject && (
              <button
                ...
                className="action-queue-card__button action-queue-card__button--critical"
              >
                Reject
              </button>
            )}
      ...
      {action.conversionRate !== undefined && (
        <div className="action-queue-card__footer">
