...
export default function IdeasRoute() {
  const data = useLoaderData<IdeaPoolLoaderData>();
  ...
  return (
    <Page
      title="Idea Pool"
      subtitle={`${data.totalIdeas} of ${data.maxIdeas} ideas`}
      backAction={{ content: "Dashboard", url: "/app" }}
    >
      <Layout>
        {/* Summary Card */}
