 ...
 */
export function getFeatureFlagsWithOverrides(
  ...
  return {
    ideaPool:
      searchParams.get("feature_idea_pool") === "1" || baseFlags.ideaPool,
    socialPosting:
      searchParams.get("feature_social_posting") === "1" ||
      baseFlags.socialPosting,
    advancedAnalytics:
      searchParams.get("feature_advanced_analytics") === "1" ||
      baseFlags.advancedAnalytics,
    aiSuggestions:
      searchParams.get("feature_ai_suggestions") === "1" ||
