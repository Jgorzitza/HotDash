...
export interface Conversation {
  ...
  summary?: string; // Summarized old messages for context window management
  createdAt: string;
  updatedAt: string;
  metadata?: {
    totalTokens?: number;
...
export async function addMessage(
  ...
  try {
    ...
    const conversation = existing.payload as Conversation;
...
export async function getConversation(
  ...
  try {
    ...
    const conversation = data.payload as Conversation;
