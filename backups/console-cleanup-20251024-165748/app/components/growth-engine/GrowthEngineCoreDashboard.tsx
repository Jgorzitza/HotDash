...
import { 
  ...
  PerformanceMonitor, 
  RouteNavigation,
  useGrowthEngineRoute 
} from './GrowthEngineRouter';
import { 
  growthEngineCacheManager, 
  growthEngineStateOptimizer, 
  growthEnginePerformanceMonitor 
} from '~/services/growth-engine/performance-optimizer';

interface GrowthEngineCoreDashboardProps {
...
export function GrowthEngineCoreDashboard({
  userPermissions,
  currentPhase,
  shopDomain,
  operatorEmail
}: GrowthEngineCoreDashboardProps) {
    ...
    >
      <div style={{ padding: 'var(--occ-space-4)' }}>
        ...
        <div style={{
          ...
          <MetricCard
            title="Average ROI"
            value={`${metrics.averageROI.toFixed(1)}x`}
            color="var(--occ-text-success)"
          />
          <MetricCard
            title="Total Revenue"
          ...
          <MetricCard
            ...
            value={`${metrics.phaseProgress.toFixed(1)}%`}
            color="var(--occ-text-info)"
          />
          <MetricCard
 ...
 */
async function fetchDashboardMetrics(shopDomain: string, phase: number): Promise<DashboardMetrics> {
