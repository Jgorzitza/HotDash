...
export interface AdCreativeImage {
  id: string; // customer_photos.id
  imageUrl: string;
  thumbnailUrl?: string;
  metadata: AdCreativeMetadata;
  description?: string; // GPT-4 Vision generated description
  uploadedAt: string;
}
...
export interface RecommendationRequest {
  // Reference creative to find similar high performers
  referenceImageId: string;
