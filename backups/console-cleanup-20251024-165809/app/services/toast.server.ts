...
export interface ToastMessage {
  ...
  type: ToastType;
  duration?: number;
  retryUrl?: string; // For error toasts with retry functionality
}
 ...
 */
export async function getToast(request: Request): Promise<ToastMessage | null> {
 ...
 */
function setToast(session: any, toast: ToastMessage) {
 ...
 */
export async function successToastHeaders(
  request: Request,
  message: string,
  duration?: number
): Promise<Headers> {
 ...
 */
export async function errorToastHeaders(
  request: Request,
  message: string,
  retryUrl?: string,
  duration?: number
 ...
 */
export async function infoToastHeaders(
  request: Request,
  message: string,
  duration?: number
): Promise<Headers> {
 ...
 */
export async function warningToastHeaders(
  request: Request,
  message: string,
  duration?: number
): Promise<Headers> {
