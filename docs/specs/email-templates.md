...
<head>
  ...
  <style>
    ...
    .metric-card { background-color: #f9f9f9; padding: 15px; margin: 10px 0; border-left: 4px solid #E74C3C; }
    .metric-label { font-size: 12px; color: #666666; text-transform: uppercase; }
    .metric-value { font-size: 32px; font-weight: bold; color: #333333; margin: 5px 0; }
    .metric-trend { font-size: 14px; color: #00AA44; }
    .metric-trend.down { color: #CC0000; }
    .cta-button { display: inline-block; background-color: #E74C3C; color: #ffffff; padding: 12px 30px; text-decoration: none; border-radius: 4px; font-weight: bold; margin: 20px 0; }
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <!-- Key Insights -->
      <h2 style="font-size: 18px; color: #333333; margin-top: 30px;">Key Insights</h2>
...
<head>
  ...
  <style>
    ...
    .alert-banner { background-color: #CC0000; color: #ffffff; padding: 15px; text-align: center; font-weight: bold; }
    .product-info { background-color: #fff3cd; border-left: 4px solid #FFA500; padding: 15px; margin: 20px 0; }
  </style>
</head>
<body>
  <div class="container">
    ...
    <!-- Content -->
    <div class="content">
      <h1 style="color: #CC0000; font-size: 22px;">Immediate Action Required</h1>
      ...
      <div class="product-info">
        ...
        <p style="margin: 5px 0;"><strong>Current Stock:</strong> {quantity} units</p>
        <p style="margin: 5px 0;"><strong>Threshold:</strong> {threshold} units</p>
        <p style="margin: 5px 0;"><strong>Days of Cover:</strong> {days} days</p>
        <p style="margin: 5px 0;"><strong>Avg Daily Sales:</strong> {avg_sales} units</p>
      </div>
      ...
      <p style="background-color: #f9f9f9; padding: 15px; border-left: 4px solid #0066CC;">
        <strong>Lead Time:</strong> {lead_time} days<br>
        <strong>Estimated Stockout:</strong> {stockout_date} (if not reordered)
      </p>
      ...
      <p style="font-size: 14px; color: #666666;">
        ...
        Adjust alert thresholds in <a href="{settings_url}">Settings</a>.
      </p>
    </div>
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p style="font-size: 14px; color: #666666;">
        Alert triggered: {alert_condition}. Adjust alert thresholds in Settings.
      </p>
    </div>
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <table style="width: 100%; border-collapse: collapse;">
        ...
        <tbody>
          <tr>
            ...
            <td style="padding: 10px; text-align: center; color: #00AA44;">▲ {positions}</td>
            <td style="padding: 10px; text-align: center;">#{new_position}</td>
          </tr>
          <!-- More rows -->
        </tbody>
      </table>
      ...
      <ol style="line-height: 1.8;">
        <li><a href="{page_1_url}">{page_1_title}</a> — {sessions_1} sessions</li>
        <li><a href="{page_2_url}">{page_2_title}</a> — {sessions_2} sessions</li>
        <li><a href="{page_3_url}">{page_3_title}</a> — {sessions_3} sessions</li>
      </ol>
