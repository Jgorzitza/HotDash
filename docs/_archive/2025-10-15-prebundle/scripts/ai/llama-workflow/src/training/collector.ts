...
interface StorageBackend {
  ...
  getAggregatedMetrics(startDate: Date, endDate: Date): Promise<AggregatedMetrics>;
}
...
export class JSONLStorage implements StorageBackend {
  ...
  private applyFilters(samples: TrainingSample[], filters: SampleFilters): TrainingSample[] {
