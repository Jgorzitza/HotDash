...
HotDash Support Team`,
...

  {
    ...
    category: "order_status",
    description:
      "Use when tracking shows delivered but customer hasn't received",
    variables: [
      "customer_name",
      "order_number",
      "delivery_date",
 ...
 */
export function getTemplatesByTag(tag: string): ResponseTemplate[] {
...
export const templateStats = {
  ...
  by_category: {
    ...
    acknowledgment: templates.filter((t) => t.category === "acknowledgment")
      .length,
