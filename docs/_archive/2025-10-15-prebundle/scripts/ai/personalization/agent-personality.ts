...
export function customizeTone(response: string, profile: keyof typeof PERSONALITY_PROFILES): string {
  ...
  if (!customized.includes('Best regards') && !customized.includes('Have a great')) {
