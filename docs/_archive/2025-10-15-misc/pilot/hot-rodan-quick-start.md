# Hot Rodan Dashboard - Quick Start Guide
...
**Quick Action**: Click "Reorder" → Auto-fill with suggested quantities
...
**Quick Action**: Click product → See detailed sales trends
