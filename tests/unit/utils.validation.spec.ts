...
describe('validation utilities', () => {
  ...
  describe('isValidShopifyGid', () => {
    ...
    it('should validate resource type', () => {
      ...
      expect(isValidShopifyGid('gid://shopify/Order/123', 'Product')).toBe(false);
    });
  });

  describe('extractIdFromGid', () => {
    it('should extract numeric ID from GID', () => {
      expect(extractIdFromGid('gid://shopify/Order/123456789')).toBe('123456789');
      expect(extractIdFromGid('gid://shopify/Product/987654321')).toBe('987654321');
    });
