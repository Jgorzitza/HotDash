...
describe('storeSearchConsoleMetrics', () => {
  ...
  it('should normalize date to midnight', async () => {
    ...
    const call = (prisma.seoSearchConsoleMetrics.upsert as any).mock.calls[0][0];
...
describe('storeSearchConsoleSummary', () => {
  beforeEach(() => {
    ...
    const { getSearchAnalytics, getTopQueries, getLandingPages } = 
  ...
  it('should throw error on API failure', async () => {
    ...
    await expect(storeSearchConsoleSummary()).rejects.toThrow('API quota exceeded');
  });
});
...
describe('getHistoricalMetrics', () => {
  ...
  it('should fetch metrics for specified days', async () => {
    ...
    (prisma.seoSearchConsoleMetrics.findMany as any).mockResolvedValue(mockRecords);
  ...
  it('should default to 30 days', async () => {
    ...
    const call = (prisma.seoSearchConsoleMetrics.findMany as any).mock.calls[0][0];
