...
describe('SEO Rankings Tracker', () => {
  ...
  describe('getTopKeywords', () => {
    it('returns keywords sorted by position', () => {
      const rankings: KeywordRanking[] = [
        { keyword: 'k1', url: '/p1', position: 5, device: 'mobile', country: 'US', clicks: 10, impressions: 100, ctr: 0.1, date: '2025-10-15' },
        { keyword: 'k2', url: '/p2', position: 2, device: 'mobile', country: 'US', clicks: 20, impressions: 200, ctr: 0.1, date: '2025-10-15' },
        { keyword: 'k3', url: '/p3', position: 8, device: 'mobile', country: 'US', clicks: 5, impressions: 50, ctr: 0.1, date: '2025-10-15' },
      ];
  ...
  describe('getHighVolumeKeywords', () => {
    it('returns keywords sorted by impressions', () => {
      const rankings: KeywordRanking[] = [
        { keyword: 'k1', url: '/p1', position: 5, device: 'mobile', country: 'US', clicks: 10, impressions: 500, ctr: 0.02, date: '2025-10-15' },
        { keyword: 'k2', url: '/p2', position: 2, device: 'mobile', country: 'US', clicks: 20, impressions: 2000, ctr: 0.01, date: '2025-10-15' },
        { keyword: 'k3', url: '/p3', position: 8, device: 'mobile', country: 'US', clicks: 5, impressions: 100, ctr: 0.05, date: '2025-10-15' },
      ];
  ...
  describe('calculateAveragePosition', () => {
    it('calculates average position correctly', () => {
      const history: KeywordHistory = {
        ...
        url: '/test',
        rankings: [
          { date: '2025-10-10', position: 5, clicks: 10, impressions: 100, ctr: 0.1 },
          { date: '2025-10-11', position: 3, clicks: 15, impressions: 120, ctr: 0.125 },
          { date: '2025-10-12', position: 4, clicks: 12, impressions: 110, ctr: 0.109 },
        ],
      };
  ...
  describe('getRankingTrend', () => {
    it('detects improving trend', () => {
      const history: KeywordHistory = {
        ...
        url: '/test',
        rankings: [
          { date: '2025-10-10', position: 10, clicks: 5, impressions: 100, ctr: 0.05 },
          { date: '2025-10-11', position: 8, clicks: 7, impressions: 110, ctr: 0.064 },
          { date: '2025-10-12', position: 5, clicks: 10, impressions: 120, ctr: 0.083 },
        ],
      };
    ...
    it('detects declining trend', () => {
      const history: KeywordHistory = {
        ...
        url: '/test',
        rankings: [
          { date: '2025-10-10', position: 5, clicks: 10, impressions: 120, ctr: 0.083 },
          { date: '2025-10-11', position: 8, clicks: 7, impressions: 110, ctr: 0.064 },
          { date: '2025-10-12', position: 10, clicks: 5, impressions: 100, ctr: 0.05 },
        ],
      };
    ...
    it('detects stable trend', () => {
      const history: KeywordHistory = {
        ...
        url: '/test',
        rankings: [
          { date: '2025-10-10', position: 7, clicks: 8, impressions: 110, ctr: 0.073 },
          { date: '2025-10-11', position: 7, clicks: 8, impressions: 110, ctr: 0.073 },
          { date: '2025-10-12', position: 8, clicks: 7, impressions: 105, ctr: 0.067 },
        ],
      };
