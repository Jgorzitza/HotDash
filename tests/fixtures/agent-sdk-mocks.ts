...
export function mockChatwootMessageCreated(
  overrides: Partial<ChatwootWebhook> = {},
): ChatwootWebhook {
  return {
...
export function mockAgentSDKDraft(
  overrides: Partial<AgentSDKDraft> = {},
): AgentSDKDraft {
  return {
    draft_response:
...
export function expectQueueEntry(entry: any, expected: Partial<QueueItem>) {
