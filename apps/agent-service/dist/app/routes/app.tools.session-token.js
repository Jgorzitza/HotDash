...
export default function SessionTokenTool() {
    ...
    return (<s-page heading="Session token utility">
      <s-stack gap="base">
        <s-section heading="Current session token">
          <s-stack gap="base">
            ...
            <s-stack direction="inline" gap="base">
              ...
              {expiresInSeconds !== null && (<s-badge tone={expiresInSeconds < 15 ? "critical" : "success"}>
            ...
            {errorMessage && (<s-box padding="base" borderWidth="base" borderRadius="base" background="subdued">
                <strong>Unable to fetch session token:</strong> {errorMessage}
              </s-box>)}
          </s-stack>
        </s-section>

        {claims && (<s-section heading="Decoded claims (server validated)">
            <s-stack gap="base">
              <s-stack direction="inline" gap="base">
                <s-text>
...
//# sourceMappingURL=app.tools.session-token.js.map