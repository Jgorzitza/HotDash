...
async function getGrowthEngineMetrics() {
    ...
    const successfulActions = executedActions.filter(action => action.execution_result && action.execution_result.success === true).length;
...
//# sourceMappingURL=api.analytics.realtime-metrics.js.map