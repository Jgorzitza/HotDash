...
import { diagnoseIssue, createResolutionWorkflow, approveResolution, applyResolution, rollbackResolution } from "~/services/seo/automated-resolution";
 ...
 */
async function handleDiagnose(params) {
    const { alert } = params;
    if (!alert) {
        return Response.json({
            success: false,
...
//# sourceMappingURL=api.seo.alerts.js.map