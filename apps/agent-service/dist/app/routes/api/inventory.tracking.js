    ...
    try {
        switch (action) {
            case "track-inventory-change":
                ...
                const previousStock = parseFloat(formData.get("previousStock"));
            ...
            case "bulk-inventory-update":
                const updatesData = formData.get("updates");
                if (!updatesData) {
...
export function initializeInventoryTracking(trackingService) {
