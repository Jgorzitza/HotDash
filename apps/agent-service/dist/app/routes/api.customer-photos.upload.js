...
export async function action({ request }) {
    ...
    try {
        ...
        const project = formData.get('project') || 'occ';
...
async function processAndUploadImage(params) {
    const { buffer, fileName, mimeType, conversationId, messageId, shopDomain, customerEmail, description, project, } = params;
...
//# sourceMappingURL=api.customer-photos.upload.js.map