 ...
 */
import { detectAnomalies, detectAllAnomalies, } from "~/services/analytics/anomaly-detection";
export async function loader({ request }) {
    ...
    try {
        ...
        const anomalies = await detectAnomalies(metric, project, days);
        return Response.json({
            success: true,
            data: {
                metric,
...
//# sourceMappingURL=api.analytics.anomalies.js.map