...
export async function loader({ request }) {
    try {
        ...
        const performanceData = aggregatePerformanceData(currentPerformances, alerts, dateRange);
        ...
        if (includeComparison && dateRange === "LAST_7_DAYS") {
            try {
                const previousPerformances = await adsClient.getCampaignPerformance(customerIds, "PREVIOUS_7_DAYS");
...
//# sourceMappingURL=api.ads.performance.js.map