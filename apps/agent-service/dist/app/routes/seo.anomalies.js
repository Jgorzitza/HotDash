...
import { Page, Layout, Card, BlockStack, InlineStack, Text, Badge, DataTable, Button, Divider, } from "@shopify/polaris";
...
import { detectTrafficAnomalies, detectRankingAnomalies, detectVitalsAnomalies, detectCrawlAnomalies, } from "~/lib/seo/anomalies";
...
export async function loader({ request }) {
    ...
    try {
        ...
        const factMetadata = (gaResult.fact.metadata ?? {});
        const generatedAt = typeof factMetadata?.generatedAt === "string"
...
function getSeverityBadge(severity) {
    switch (severity) {
        case "critical":
            return { tone: "critical", children: "Critical" };
        case "warning":
            return { tone: "warning", children: "Warning" };
        case "info":
            return { tone: "info", children: "Info" };
    }
}
function getAnomalyTypeBadge(type) {
    switch (type) {
        case "traffic":
            return { tone: "info", children: "Traffic" };
        case "ranking":
            return { tone: "attention", children: "Ranking" };
        case "vitals":
            return { tone: "warning", children: "Web Vitals" };
        case "crawl":
            return { tone: "critical", children: "Crawl Error" };
        default:
            return { tone: "info", children: type };
    }
}
export default function SEOAnomaliesDashboard() {
    ...
    return (<Page title="SEO Monitoring Dashboard" subtitle="Comprehensive SEO health monitoring and anomaly detection" backAction={{ content: "Dashboard", url: "/" }}>
      <Layout>
        {/* Summary Cards */}
        <Layout.Section>
          <InlineStack gap="400">
        ...
        {/* Search Console Metrics */}
        {data.searchConsole && (<Layout.Section>
            <Card>
              <BlockStack gap="400">
                ...
                <InlineStack gap="600">
                  <BlockStack gap="200">
                    ...
                    <Text as="p" variant="bodySm" tone={data.searchConsole.analytics.clicksChange >= 0 ? "success" : "critical"}>
                  ...
                  <BlockStack gap="200">
                    ...
                    <Text as="p" variant="bodySm" tone={data.searchConsole.analytics.impressionsChange >= 0 ? "success" : "critical"}>
                  ...
                  <BlockStack gap="200">
                    ...
                    <Text as="p" variant="bodySm" tone={data.searchConsole.analytics.ctrChange >= 0 ? "success" : "critical"}>
                  ...
                  <BlockStack gap="200">
                    ...
                    <Text as="p" variant="bodySm" tone={data.searchConsole.analytics.positionChange <= 0 ? "success" : "critical"}>
        ...
        <Layout.Section>
          <Card>
            <BlockStack gap="400">
              ...
              <Divider />
              {data.anomalies.length > 0 ? (<DataTable columnContentTypes={["text", "text", "text", "text", "text", "numeric", "numeric"]} headings={["Severity", "Type", "Title", "Description", "URL", "Current", "Change"]} rows={anomalyRows}/>) : (<BlockStack gap="200">
...
//# sourceMappingURL=seo.anomalies.js.map