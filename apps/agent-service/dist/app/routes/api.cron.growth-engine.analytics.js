...
export async function action({ request }) {
    ...
    try {
        ...
        console.log('[Analytics Agent] Starting daily analysis...');
        ...
        console.log(`[Analytics Agent] Completed in ${duration}ms, generated ${actions.length} actions`);
        return Response.json({
            success: true,
            actionsGenerated: actions.length,
            durationMs: duration,
...
//# sourceMappingURL=api.cron.growth-engine.analytics.js.map