...
export default function App() {
    const { apiKey, mockMode, pendingCount: initialPendingCount, } = useLoaderData();
    ...
    return (<AppProvider embedded apiKey={apiKey} i18n={enTranslations}>
      <ToastProvider>
        <s-app-nav>
          ...
          <s-link href="/app/approvals">
            ...
            {livePendingCount > 0 && (<span style={{ marginLeft: "var(--occ-space-2)" }}>
