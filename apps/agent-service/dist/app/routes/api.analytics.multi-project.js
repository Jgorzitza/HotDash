 ...
 */
import { getMultiProjectSummary, compareProjects, getProjectRankings, getTopProjectsByMetric, } from "~/services/analytics/multi-project";
export async function loader({ request }) {
    ...
    try {
        ...
        if (action === "top") {
            ...
            const topProjects = await getTopProjectsByMetric(metric, limit, days);
            return Response.json({
                success: true,
                data: topProjects,
...
//# sourceMappingURL=api.analytics.multi-project.js.map