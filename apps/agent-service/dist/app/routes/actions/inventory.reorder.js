...
export const action = async ({ request }) => {
    ...
    if (typeof velocityAnalysisRaw === "string" &&
    ...
    const payload = {
        ...
        reorderQuantity: typeof reorderQuantity === "string"
    ...
    if (supabaseConfig) {
        ...
        const { error: insertError } = await supabase
            ...
            reorder_quantity: typeof reorderQuantity === "string"
                ? Number.parseInt(reorderQuantity, 10)
                : null,
            vendor_id: typeof vendor === "string" ? vendor : null, // Note: This is vendor name, not UUID - needs enhancement
            velocity_analysis: typeof velocityAnalysisRaw === "string" ? velocityAnalysisRaw : null,
            operator_name: actor,
...
//# sourceMappingURL=inventory.reorder.js.map