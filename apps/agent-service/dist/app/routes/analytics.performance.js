...
export default function PerformanceAnalytics() {
    const { analysis, optimization, error } = useLoaderData();
    ...
    return (<div style={{
      ...
      <PerformanceOptimizationDashboard analysis={analysis} optimization={optimization} loading={revalidator.state === 'loading'} error={error}/>
...
//# sourceMappingURL=analytics.performance.js.map