 ...
 */
import { generateGrowthEngineAnalytics, exportGrowthEngineAnalytics, getMockGrowthEngineData } from "~/services/analytics/growthEngineAdvanced";
export async function loader({ request }) {
    try {
        ...
        // Generate analytics
        const analytics = await generateGrowthEngineAnalytics(actions, attributionData, startDate, endDate);
...
//# sourceMappingURL=api.analytics.growth-engine.js.map