...
export async function action({ request }) {
    ...
    try {
        ...
        return Response.json({ error: "visibleTiles must be valid JSON array" }, { status: 400 });
    }
    if (!Array.isArray(visibleTiles)) {
        return Response.json({ error: "visibleTiles must be an array" }, { status: 400 });
    }
...
//# sourceMappingURL=api.preferences.visible-tiles.js.map