 ...
 */
function extractSEOElements(html, url) {
 ...
 */
function analyzeSEOElements(elements) {
    const issues = [];
    // Title checks
    if (!elements.title) {
        issues.push({
 ...
 */
export async function runDailyAudit(urls) {
 ...
 */
export async function getURLsToAudit(shopDomain) {
...
//# sourceMappingURL=automated-audit.js.map