 ...
 */
export async function addDocument(fileName, content, autoReindex = true) {
    try {
        // Validate filename
 ...
 */
export async function updateDocument(fileName, content, autoReindex = true) {
    try {
        const filePath = path.join(SUPPORT_DIR, fileName);
        // Verify file exists
        await fs.access(filePath);
 ...
 */
export async function deleteDocument(fileName, autoReindex = true) {
    try {
        const filePath = path.join(SUPPORT_DIR, fileName);
        // Delete file
...
//# sourceMappingURL=kb-admin.js.map