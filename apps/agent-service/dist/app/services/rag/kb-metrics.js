...
export async function calculateHealthScore() {
    ...
    // Category coverage
    const categories = new Set(metadata.sources?.map((s) => getCategoryFromFilename(s.fileName)) ||
        []);
    ...
    const overall = Math.round(coverageScore * 0.3 +
...
//# sourceMappingURL=kb-metrics.js.map