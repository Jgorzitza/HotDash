 ...
 */
export async function calculateAdvancedAttribution(actions, attributionData) {
 ...
 */
export async function generateGrowthEngineAnalytics(actions, attributionData, startDate, endDate) {
    ...
    budgetRecommendations.expectedImpact = efficientActions.reduce((sum, data) => sum + data.efficiency.efficiencyScore, 0) / Math.max(efficientActions.length, 1);
...
//# sourceMappingURL=growthEngineAdvanced.js.map