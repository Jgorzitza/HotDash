 ...
 */
export async function exportLaunchMetricsToGA(metrics) {
 ...
 */
async function exportUserEngagementMetrics(metrics, propertyId) {
    // Send DAU metric
 ...
 */
async function exportFeatureAdoptionMetrics(metrics, propertyId) {
 ...
 */
async function exportSatisfactionMetrics(metrics, propertyId) {
    // Send NPS metric
    await sendGAEvent(propertyId, {
 ...
 */
async function sendGAEvent(propertyId, event) {
...
//# sourceMappingURL=ga-export.js.map