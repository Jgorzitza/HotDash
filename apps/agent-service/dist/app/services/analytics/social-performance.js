 ...
 */
export async function trackSocialPostPerformance(postId, shopDomain = "occ") {
 ...
 */
async function fetchPublerMetrics(publerPostId) {
...
function calculateMetrics(raw) {
    ...
    const engagementRate = raw.impressions > 0 ? (engagement / raw.impressions) * 100 : 0;
    return {
 ...
 */
async function storeSocialMetrics(shopDomain, postId, platform, metrics) {
 ...
 */
export async function getSocialPerformanceSummary(shopDomain = "occ", platform, days = 30) {
...
//# sourceMappingURL=social-performance.js.map