 ...
 */
export async function* generateCSVStream(options) {
 ...
 */
function generateCSVHeader(type) {
    const headers = {
        social: "Date,Post ID,Platform,Impressions,Clicks,Engagement,CTR,Engagement Rate\n",
        ...
        growth: "Date,Total Impressions,Total Clicks,Total Conversions,Avg CTR,Avg Conversion Rate,Total Revenue,Total Spend,Overall ROAS\n",
 ...
 */
async function* streamSocialData(shopDomain, startDate, endDate) {
    const where = {
        shopDomain,
 ...
 */
async function* streamSEOData(shopDomain, startDate, endDate) {
    const where = {
        shopDomain,
 ...
 */
async function* streamAdsData(shopDomain, startDate, endDate) {
    const where = {
        shopDomain,
        factType: "ads_roas",
    };
 ...
 */
async function* streamGrowthData(shopDomain, startDate, endDate) {
 ...
 */
export async function createCSVStream(options) {
 ...
 */
export function generateExportFilename(type, format = "csv") {
