 ...
 */
export async function generateDailyReport(shopDomain = "occ") {
    ...
    return {
        ...
        emailTemplate: generateDailyEmailTemplate(shopDomain, metrics, highlights, anomalies.anomalies.length),
    };
}
/**
 * Generate weekly analytics report
 */
export async function generateWeeklyReport(shopDomain = "occ") {
    const today = new Date();
    ...
    return {
        ...
        emailTemplate: generateWeeklyEmailTemplate(shopDomain, metrics, highlights, anomalies.anomalies.length),
    };
}
/**
 * Generate monthly analytics report
 */
export async function generateMonthlyReport(shopDomain = "occ") {
    const today = new Date();
    ...
    return {
        ...
        emailTemplate: generateMonthlyEmailTemplate(shopDomain, metrics, highlights, anomalies.anomalies.length),
    };
}
/**
 * Generate daily highlights
 */
function generateDailyHighlights(metrics, anomalies) {
    const highlights = [];
 ...
 */
function generateWeeklyHighlights(metrics, anomalies) {
    const highlights = [];
 ...
 */
function generateMonthlyHighlights(metrics, anomalies) {
    const highlights = [];
    ...
    if (metrics.overallROAS > 0) {
        ...
        highlights.push(`Net profit: $${profit.toFixed(2)} (ROAS: ${metrics.overallROAS}x)`);
    }
    return highlights;
}
/**
 ...
 */
function generateDailyEmailTemplate(shopDomain, metrics, highlights, anomalyCount) {
 ...
 */
function generateWeeklyEmailTemplate(shopDomain, metrics, highlights, anomalyCount) {
 ...
 */
function generateMonthlyEmailTemplate(shopDomain, metrics, highlights, anomalyCount) {
