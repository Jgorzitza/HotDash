 ...
 */
export async function getWoWVariance(project, metric, supabaseUrl, supabaseKey) {
    ...
    try {
        ...
        // Determine trend
        const trend = variance > 5 ? "up" : variance < -5 ? "down" : "flat";
        return {
            current,
            previous,
 ...
 */
function getFactTypeForMetric(metric) {
    switch (metric) {
        case "revenue":
 ...
 */
function aggregateMetricValue(data, metric) {
    if (data.length === 0)
        return 0;
...
//# sourceMappingURL=wow-variance.js.map