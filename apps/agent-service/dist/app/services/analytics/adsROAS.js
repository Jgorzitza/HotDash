 ...
 */
export function calculateROAS(spend, revenue) {
    if (spend === 0)
        return 0;
 ...
 */
export function calculateCampaignMetrics(campaignId, campaignName, platform, spend, revenue, conversions, clicks, impressions, startDate, endDate) {
 ...
 */
export function analyzeROASPerformance(campaigns, previousCampaigns = [], startDate, endDate) {
    ...
    const bestPerformingCampaign = campaigns.reduce((best, current) => current.roas > best.roas ? current : best);
    const worstPerformingCampaign = campaigns.reduce((worst, current) => current.roas < worst.roas ? current : worst);
 ...
 */
export function generateROASRecommendations(analysis, campaigns) {
 ...
 */
export function exportROASMetrics(analysis) {
    return {
        summary: {
 ...
 */
export function calculateROASEfficiencyScore(analysis) {
...
//# sourceMappingURL=adsROAS.js.map