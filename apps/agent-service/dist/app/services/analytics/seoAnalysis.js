 ...
 */
export function calculateRankingDeltas(currentRankings, previousRankings) {
 ...
 */
export function analyzeSEOImpact(rankings, startDate, endDate) {
 ...
 */
export function analyzeContentSEOImpact(contentId, title, url, publishedAt, keywordChanges) {
 ...
 */
export function generateSEOReport(analysis, contentImpacts) {
    const report = {
        summary: {
 ...
 */
function generateSEORecommendations(analysis, contentImpacts) {
 ...
 */
export function exportSEOMetrics(analysis) {
    return {
        metrics: {
            totalKeywords: analysis.totalKeywords,
            improvementRate: analysis.totalKeywords > 0
...
//# sourceMappingURL=seoAnalysis.js.map