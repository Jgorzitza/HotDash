...
export class DashboardOptimizer {
     ...
     */
    async fetchWithOptimization(key, fetcher, options = {}) {
     ...
     */
    getVirtualizationConfig(itemCount, itemHeight = 50) {
     ...
     */
    async batchRequests(requests, batchSize = this.config.maxConcurrentRequests) {
        const results = {};
...
//# sourceMappingURL=dashboardOptimization.js.map