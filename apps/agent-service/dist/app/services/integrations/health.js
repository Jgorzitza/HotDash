...
export async function checkPublerHealth() {
...
export async function checkShopifyHealth(adminGraphqlClient) {
    const startTime = Date.now();
    try {
...
export async function checkAllIntegrations(adminGraphqlClient) {
