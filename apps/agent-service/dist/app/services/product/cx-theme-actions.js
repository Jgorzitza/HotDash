 ...
 */
export function mapThemeToImplementationType(theme) {
    const themeMap = {
 ...
 */
export function generateDraftCopy(theme, productTitle, occurrences) {
 ...
 */
export async function generateCXThemeAction(theme, shopDomain) {
    // Get product details
 ...
 */
export async function processCXThemes(themes, shopDomain) {
    const actions = [];
 ...
 */
export async function addCXActionsToQueue(actions, shopDomain) {
    const facts = [];
...
//# sourceMappingURL=cx-theme-actions.js.map