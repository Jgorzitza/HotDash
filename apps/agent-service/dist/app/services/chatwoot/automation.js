 ...
 */
export async function applyAutomations(conversation) {
 ...
 */
function evaluateConditions(conversation, conditions) {
 ...
 */
function evaluateCondition(conversation, condition) {
 ...
 */
async function executeActions(conversation, actions) {
 ...
 */
async function executeAction(config, conversation, action) {
    const { action_name, action_params } = action;
    switch (action_name) {
        case "assign_agent": {
            const agentId = action_params?.agent_id;
            if (agentId) {
        ...
        case "add_label": {
            const labels = action_params?.labels;
        ...
        case "send_message": {
            const message = action_params?.message;
            if (message) {
...
// CHATWOOT API CALLS
// ============================================================================
async function assignConversation(config, conversationId, agentId) {
...
async function addLabels(config, conversationId, labels) {
...
async function sendPrivateNote(config, conversationId, message) {
...
async function muteConversation(config, conversationId) {
 ...
 */
export async function sendAfterHoursReply(conversationId) {
    if (!isAfterHours()) {
