...
export class FeatureFlagService {
     ...
     */
    async isFeatureEnabled(flagId, userId, userSegment) {
     ...
     */
    async checkFeature(flagId, userId, userSegment) {
     ...
     */
    async updateRolloutPercentage(flagId, percentage) {
     ...
     */
    async addTargetUser(flagId, userId) {
        const flag = await this.getFeatureFlag(flagId);
        if (flag) {
     ...
     */
    async removeTargetUser(flagId, userId) {
        const flag = await this.getFeatureFlag(flagId);
     ...
     */
    isUserInRollout(userId, flagId, percentage) {
