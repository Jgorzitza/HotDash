 ...
 * ```
 */
export async function indexAdCreative(request) {
 ...
 * ```
 */
export async function batchIndexCreatives(request) {
    const startTime = Date.now();
    try {
        let creatives = [];
        ...
        const results = await Promise.allSettled(creatives.map(creative => indexAdCreative({
 ...
 * @private
 */
async function fetchGoogleAdCreatives(campaignId, dateRange) {
 ...
 * @private
 */
async function fetchFacebookAdCreatives(campaignId, dateRange) {
    // Note: This is a placeholder implementation
 ...
 * @private
 */
function buildCreativeMetadata(creative, platform) {
 ...
 */
export async function reindexCreatives(imageIds, dateRange) {
    const startTime = Date.now();
    try {
 ...
 */
export async function deleteIndexedCreative(imageId) {
    try {
...
//# sourceMappingURL=creative-indexing.js.map