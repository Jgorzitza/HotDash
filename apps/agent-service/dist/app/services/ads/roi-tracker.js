 ...
 */
export function calculateROIAttribution(conversions, model = 'last_click') {
 ...
 */
export function calculateCLVMetrics(campaignId, campaignName, customerData) {
 ...
 */
export function generateROITrackingSummary(conversions, customerData, model = 'last_click') {
...
//# sourceMappingURL=roi-tracker.js.map