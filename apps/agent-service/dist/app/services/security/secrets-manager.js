...
// Secret Categories
// ============================================================================
export var SecretCategory;
(function (SecretCategory) {
    SecretCategory["SHOPIFY"] = "shopify";
    SecretCategory["DATABASE"] = "database";
    SecretCategory["CHATWOOT"] = "chatwoot";
    SecretCategory["SOCIAL"] = "social";
    SecretCategory["ANALYTICS"] = "analytics";
    SecretCategory["COMMUNICATION"] = "communication";
    SecretCategory["INFRASTRUCTURE"] = "infrastructure";
...
export class SecretsManager {
    ...
    getSecretsNeedingRotation() {
        ...
        this.metadata.forEach((meta) => {
            ...
            if (meta.lastRotated) {
                const daysSinceRotation = Math.floor((now.getTime() - meta.lastRotated.getTime()) / (1000 * 60 * 60 * 24));
