 ...
 */
export async function executeAction(request, supabaseUrl, supabaseKey) {
    ...
    try {
        ...
        const approvalStatus = approval.payload?.approvalStatus;
 ...
 */
async function executeCXAction(request, apiCalls) {
 ...
 */
async function executeInventoryAction(request, apiCalls) {
    const { payload } = request;
    const callStart = Date.now();
 ...
 */
async function executeSocialAction(request, apiCalls) {
    const { payload } = request;
    const callStart = Date.now();
 ...
 */
async function executeProductAction(request, apiCalls) {
    const { payload } = request;
    const callStart = Date.now();
 ...
 */
async function executeAdsAction(request, apiCalls) {
    const { payload } = request;
    const callStart = Date.now();
