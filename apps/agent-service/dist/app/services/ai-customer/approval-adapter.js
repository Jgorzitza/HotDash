 ...
 */
export async function createApproval(action, userId, supabaseUrl, supabaseKey) {
 ...
 */
export async function updateApprovalStatus(approvalId, status, userId, modifications, supabaseUrl, supabaseKey) {
    const supabase = createClient(supabaseUrl, supabaseKey);
    try {
 ...
 */
export async function getPendingApprovals(userId, actionType, limit, supabaseUrl, supabaseKey) {
    const supabase = createClient(supabaseUrl, supabaseKey);
    try {
        let query = supabase
            .from("decision_log")
        ...
        console.error("[Approval Adapter] Error fetching pending approvals:", error);
        return [];
    }
}
/**
...
//# sourceMappingURL=approval-adapter.js.map