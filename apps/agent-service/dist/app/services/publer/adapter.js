...
export class PublerAdapter {
     ...
     */
    convertApprovalToPost(approval) {
        return {
     ...
     */
    async publishApproval(approval) {
    ...
    async checkPublishStatus(jobId) {
        try {
    ...
    updateReceiptFromJobStatus(receipt, jobStatus) {
...
export function createPublerAdapter() {
