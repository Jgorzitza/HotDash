...
describe('Growth Engine Support Framework', () => {
    ...
    describe('MCP Evidence Service', () => {
        it('should initialize evidence file', async () => {
            const evidencePath = await mcpEvidenceService.initializeEvidenceFile(testAgent, testDate, 'test-topic');
        ...
        it('should validate evidence entry format', async () => {
            ...
            await expect(mcpEvidenceService.appendEvidence(testAgent, testDate, 'test-topic', invalidEntry)).rejects.toThrow();
        });
    ...
    describe('Growth Engine Support Framework', () => {
        ...
        it('should log MCP usage', async () => {
            ...
            await framework.initialize();
            await framework.logMCPUsage('shopify-dev', 'https://shopify.dev/docs/api/admin-rest', 'req_123', 'Test MCP usage');
    ...
    describe('Integration Tests', () => {
        it('should work end-to-end', async () => {
            ...
            await framework.initialize();
            // Log MCP usage
            await framework.logMCPUsage('shopify-dev', 'https://shopify.dev/docs/api/admin-rest', 'req_123', 'Get product data');
            await framework.logMCPUsage('context7', 'https://context7.io/docs', 'req_124', 'Get library documentation');
            // Update heartbeat
...
//# sourceMappingURL=growth-engine-support.test.js.map