...
export class GSCBulkExport {
     ...
     */
    async getGSCData(startDate, endDate) {
...
export class GA4DataAPI {
    ...
    async getGA4Data(startDate, endDate) {
        ...
        try {
            ...
            const ga4Data = sessions.map(session => ({
...
export class AnalyticsTransform {
     ...
     */
    async identifyOpportunities(startDate, endDate) {
...
export class ActionQueueEmitter {
     ...
     */
    async storeAction(action, opportunity) {
        try {
...
export class TelemetryPipeline {
    ...
    transform;
    emitter;
    constructor(propertyId = '339826228') {
