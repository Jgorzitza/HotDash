 ...
 */
export function isSamplingError(error) {
    if (!error)
        return false;
    const message = error.message || error.toString();
    const lowerMessage = message.toLowerCase();
    // Check for common sampling error indicators
    return (lowerMessage.includes("sampled") ||
 ...
 */
export function validateUnsampled(response) {
...
//# sourceMappingURL=sampling-guard.js.map