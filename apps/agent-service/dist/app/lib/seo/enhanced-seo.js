...
export async function getEnhancedSEOData() {
    ...
    try {
        ...
        const traffic = gaData.status === "fulfilled"
            ? gaData.value
            : {
                totalSessions: 0,
                organicSessions: 0,
        ...
        const googlePercentage = totalClicks > 0 ? (google.totalClicks / totalClicks) * 100 : 0;
        const bingPercentage = totalClicks > 0 ? (bing.totalClicks / totalClicks) * 100 : 0;
...
//# sourceMappingURL=enhanced-seo.js.map