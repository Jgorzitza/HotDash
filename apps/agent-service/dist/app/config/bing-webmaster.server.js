 ...
 */
export function getBingWebmasterConfig() {
    const apiKey = process.env.BING_WEBMASTER_API_KEY ?? "";
    const siteUrl = process.env.BING_WEBMASTER_SITE_URL ?? "https://hotrodan.com";
    if (!apiKey) {
        throw new Error("BING_WEBMASTER_API_KEY is required for Bing Webmaster Tools integration");
    }
    return {
        apiKey,
        siteUrl,
...
//# sourceMappingURL=bing-webmaster.server.js.map