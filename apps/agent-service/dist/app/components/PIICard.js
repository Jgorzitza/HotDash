...
export function PIICard(props) {
    const { orderId, orderStatus, fulfillmentStatus, email, phone, shippingAddress, tracking, lineItems, } = props;
    ...
    return (<div className="pii-card" aria-label="Customer PII - Operator Only" role="region">
      {/* Warning Banner */}
        ...
        <dl className="pii-card__details">
          <div className="pii-card__detail-row">
            ...
            <dd className="pii-card__copyable">
              <span>{email}</span>
              <button type="button" onClick={() => copyToClipboard(email, "email")} className="pii-card__copy-button" aria-label="Copy email">
                {copiedField === "email" ? "✓ Copied" : "Copy"}
              </button>
            </dd>
          </div>
          {phone && (<div className="pii-card__detail-row">
              <dt>Phone</dt>
              <dd className="pii-card__copyable">
                <span>{phone}</span>
                <button type="button" onClick={() => copyToClipboard(phone, "phone")} className="pii-card__copy-button" aria-label="Copy phone">
      ...
      <div className="pii-card__section">
        ...
        <div className="pii-card__address">
          ...
          <button type="button" onClick={() => copyToClipboard(formatAddress(shippingAddress), "address")} className="pii-card__copy-button" aria-label="Copy address">
      ...
      {/* Tracking Section */}
      {tracking && (<div className="pii-card__section">
          ...
          <dl className="pii-card__details">
            ...
            <div className="pii-card__detail-row">
              ...
              <dd className="pii-card__copyable">
                ...
                <button type="button" onClick={() => copyToClipboard(tracking.number, "tracking")} className="pii-card__copy-button" aria-label="Copy tracking number">
            ...
            <div className="pii-card__detail-row">
              <dt>Link</dt>
              <dd>
                <a href={tracking.url} target="_blank" rel="noopener noreferrer" className="pii-card__link">
                  Track Package ↗
                </a>
              </dd>
            </div>
...
//# sourceMappingURL=PIICard.js.map