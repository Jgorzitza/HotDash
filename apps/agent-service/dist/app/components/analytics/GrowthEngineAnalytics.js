...
export function GrowthEngineAnalyticsComponent({ analytics, timeframe, period, generatedAt, }) {
    ...
    return (<div style={{ padding: "var(--occ-space-4)" }}>
      ...
      {viewMode === "overview" && (<div>
          ...
          <div style={{ marginBottom: "var(--occ-space-4)" }}>
            ...
            <div style={{
              ...
              {analytics.performanceInsights.topPerformingActions.map((action, index) => (<div key={action.actionId} style={{
                    padding: "var(--occ-space-3)",
                    border: "1px solid var(--occ-border-default)",
                    borderRadius: "var(--occ-radius-md)",
                    backgroundColor: "var(--occ-bg-surface)",
          ...
          {analytics.performanceInsights.optimizationOpportunities.length >
              ...
              <div style={{
                ...
                <ul style={{ margin: 0, paddingLeft: "var(--occ-space-4)" }}>
                  {analytics.performanceInsights.optimizationOpportunities.map((opportunity, index) => (<li key={index} style={{ marginBottom: "var(--occ-space-1)" }}>
                        {opportunity}
                      </li>))}
                </ul>
              </div>
            ...
            <table style={{
              ...
              <thead>
                ...
                borderBottom: "1px solid var(--occ-border-default)",
                  ...
                  <th style={{ padding: "var(--occ-space-2)", textAlign: "left" }}>
                    Action
                  </th>
                  <th style={{
              ...
              <tbody>
                {analytics.attributionAnalysis.map((data) => (<tr key={data.actionId} style={{
      ...
      {viewMode === "recommendations" && (<div>
          <h3 style={{ margin: 0, marginBottom: "var(--occ-space-3)" }}>
            Recommendations
          </h3>

          {/* Scaling Actions */}
          {analytics.recommendations.scalingActions.length > 0 && (<div style={{ marginBottom: "var(--occ-space-4)" }}>
              ...
              <div style={{
                ...
                <ul style={{ margin: 0, paddingLeft: "var(--occ-space-4)" }}>
                  {analytics.recommendations.scalingActions.map((action) => (<li key={action.actionId} style={{ marginBottom: "var(--occ-space-1)" }}>
          ...
          {analytics.recommendations.optimizationActions.length > 0 && (<div style={{ marginBottom: "var(--occ-space-4)" }}>
              <h4 style={{ margin: 0, marginBottom: "var(--occ-space-2)" }}>
              ...
              <div style={{
                ...
                <ul style={{ margin: 0, paddingLeft: "var(--occ-space-4)" }}>
                  {analytics.recommendations.optimizationActions.map((action, index) => (<li key={index} style={{ marginBottom: "var(--occ-space-1)" }}>
                        {action}
                      </li>))}
                </ul>
              </div>
            ...
            <div style={{
              ...
              {analytics.recommendations.budgetAdjustments.increase.length >
                0 && (<div style={{
                  ...
                  <ul style={{ margin: 0, paddingLeft: "var(--occ-space-4)" }}>
                    {analytics.recommendations.budgetAdjustments.increase.map((action, index) => (<li key={index} style={{ marginBottom: "var(--occ-space-1)" }}>
                          {action}
                        </li>))}
                  </ul>
                </div>)}
              {analytics.recommendations.budgetAdjustments.decrease.length >
                0 && (<div style={{
                  ...
                  <ul style={{ margin: 0, paddingLeft: "var(--occ-space-4)" }}>
                    {analytics.recommendations.budgetAdjustments.decrease.map((action, index) => (<li key={index} style={{ marginBottom: "var(--occ-space-1)" }}>
                          {action}
                        </li>))}
                  </ul>
                </div>)}
...
//# sourceMappingURL=GrowthEngineAnalytics.js.map