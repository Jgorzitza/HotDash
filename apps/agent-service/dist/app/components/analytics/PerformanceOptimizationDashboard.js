...
export function PerformanceOptimizationDashboard({ analysis, optimization, loading = false, error, }) {
...
function OverviewView({ analysis, optimization, }) {
    ...
    return (<div>
      ...
      <div style={{ marginBottom: "var(--occ-space-4)" }}>
        ...
        <div style={{
          ...
          {Object.entries(analysis.categories).map(([category, data]) => (<div key={category} style={{
      ...
      {/* Critical Issues */}
      {analysis.criticalIssues.length > 0 && (<div>
          <h3 style={{ margin: 0, marginBottom: "var(--occ-space-3)" }}>
            Critical Issues
          </h3>
          <div style={{ display: "grid", gap: "var(--occ-space-2)" }}>
            {analysis.criticalIssues.map((issue) => (<div key={issue.id} style={{
                    padding: "var(--occ-space-3)",
                ...
                <div>
                  ...
                  <ul style={{
                    ...
                    {issue.immediateActions.map((action, index) => (<li key={index}>{action}</li>))}
                  </ul>
                </div>
              </div>))}
          </div>
...
function AnalysisView({ analysis }) {
    return (<div>
      ...
      {/* Performance Trends */}
      {analysis.performanceTrends.length > 0 && (<div style={{ marginBottom: "var(--occ-space-4)" }}>
          <h4 style={{ margin: 0, marginBottom: "var(--occ-space-2)" }}>
            Performance Trends
          </h4>
          <div style={{ display: "grid", gap: "var(--occ-space-2)" }}>
            {analysis.performanceTrends.map((trend, index) => (<div key={index} style={{
                    padding: "var(--occ-space-3)",
                    border: "1px solid var(--occ-border-default)",
                    borderRadius: "var(--occ-radius-md)",
                    backgroundColor: "var(--occ-bg-surface)",
      ...
      <div>
        ...
        <div style={{ display: "grid", gap: "var(--occ-space-3)" }}>
          {Object.entries(analysis.categories).map(([category, data]) => (<div key={category} style={{
              ...
              {/* Bottlenecks */}
              {data.bottlenecks.length > 0 && (<div>
                  <h6 style={{ margin: 0, marginBottom: "var(--occ-space-2)" }}>
                    Bottlenecks
                  </h6>
                  <div style={{ display: "grid", gap: "var(--occ-space-2)" }}>
                    {data.bottlenecks.map((bottleneck) => (<div key={bottleneck.id} style={{
                        ...
                        borderRadius: "var(--occ-radius-sm)",
                        fontSize: "var(--occ-font-size-xs)",
                        backgroundColor: bottleneck.severity === "critical"
                            ? "var(--occ-bg-error)"
                            : "var(--occ-bg-warning)",
                        color: bottleneck.severity === "critical"
                            ? "var(--occ-color-error)"
                            : "var(--occ-color-warning)",
                        fontWeight: "var(--occ-font-weight-medium)",
                    }}>
              ...
              {/* Optimizations */}
              {data.optimizations.length > 0 && (<div>
                  <h6 style={{ margin: 0, marginBottom: "var(--occ-space-2)" }}>
                    Optimizations
                  </h6>
                  <ul style={{
                    ...
                    {data.optimizations.map((optimization, index) => (<li key={index} style={{ marginBottom: "var(--occ-space-1)" }}>
                        {optimization}
                      </li>))}
                  </ul>
                </div>)}
...
function OptimizationView({ optimization }) {
    return (<div>
      <h3 style={{ margin: 0, marginBottom: "var(--occ-space-3)" }}>
      ...
      {optimization.optimizationsApplied.length > 0 && (<div style={{ marginBottom: "var(--occ-space-4)" }}>
          <h4 style={{ margin: 0, marginBottom: "var(--occ-space-2)" }}>
            Applied Optimizations
          </h4>
          <div style={{ display: "grid", gap: "var(--occ-space-2)" }}>
            {optimization.optimizationsApplied.map((optimization, index) => (<div key={index} style={{
                    padding: "var(--occ-space-3)",
                    border: "1px solid var(--occ-border-success)",
                    borderRadius: "var(--occ-radius-md)",
                    backgroundColor: "var(--occ-bg-success-subdued)",
      ...
      {/* Optimization Log */}
      {optimization.evidence.optimizationLog.length > 0 && (<div>
          <h4 style={{ margin: 0, marginBottom: "var(--occ-space-2)" }}>
            Optimization Log
          </h4>
          <div style={{
            ...
            {optimization.evidence.optimizationLog.map((log, index) => (<div key={index} style={{ marginBottom: "var(--occ-space-1)" }}>
                {log}
              </div>))}
          </div>
        </div>)}
...
function RecommendationsView({ analysis, }) {
    return (<div>
      ...
      <div style={{ display: "grid", gap: "var(--occ-space-3)" }}>
        {analysis.recommendations.map((recommendation) => (<div key={recommendation.id} style={{
                padding: "var(--occ-space-4)",
                border: "1px solid var(--occ-border-default)",
                borderRadius: "var(--occ-radius-md)",
                backgroundColor: "var(--occ-bg-surface)",
            ...
            <div style={{
              ...
              <div style={{ display: "flex", gap: "var(--occ-space-2)" }}>
                ...
                borderRadius: "var(--occ-radius-sm)",
                fontSize: "var(--occ-font-size-xs)",
                backgroundColor: recommendation.priority === "critical"
                    ? "var(--occ-bg-error)"
                    : recommendation.priority === "high"
                        ? "var(--occ-bg-warning)"
                        : "var(--occ-bg-info)",
                color: recommendation.priority === "critical"
                    ? "var(--occ-color-error)"
                    : recommendation.priority === "high"
                        ? "var(--occ-color-warning)"
                        : "var(--occ-color-info)",
            ...
            <div>
              ...
              <ol style={{
                ...
                {recommendation.implementation.steps.map((step, index) => (<li key={index} style={{ marginBottom: "var(--occ-space-1)" }}>
                    {step}
                  </li>))}
              </ol>
            </div>
...
function MonitoringView({ analysis }) {
    return (<div>
      <h3 style={{ margin: 0, marginBottom: "var(--occ-space-3)" }}>
...
//# sourceMappingURL=PerformanceOptimizationDashboard.js.map