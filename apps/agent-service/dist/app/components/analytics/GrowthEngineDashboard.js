...
export function GrowthEngineDashboard({ analytics, loading = false, error, }) {
    ...
    return (<div style={{ padding: "var(--occ-space-4)" }}>
      ...
      <div style={{ marginBottom: "var(--occ-space-4)" }}>
        ...
        <p style={{
          ...
          Comprehensive analytics for Growth Engine phases with advanced
          capabilities
        </p>
      </div>
      ...
      <div style={{
        ...
        ].map(({ key, label }) => (<button key={key} onClick={() => setViewMode(key)} style={{
...
function OverviewView({ analytics }) {
    return (<div>
      ...
      <div style={{
        ...
        <MetricCard title="Total Phases" value={analytics.overview.totalPhases} subtitle={`${analytics.overview.activePhases} active, ${analytics.overview.completedPhases} completed`} icon="📊"/>
        <MetricCard title="Total Actions" value={analytics.overview.totalActions} subtitle={`${analytics.overview.activeActions} active, ${analytics.overview.completedActions} completed`} icon="🎯"/>
        <MetricCard title="Total Revenue" value={`$${analytics.overview.totalRevenue.toLocaleString()}`} subtitle={`${analytics.overview.totalConversions} conversions`} icon="💰"/>
        <MetricCard title="Average ROI" value={`${analytics.overview.averageROI.toFixed(1)}x`} subtitle={`${analytics.overview.overallProgress.toFixed(0)}% overall progress`} icon="📈"/>
      </div>
      ...
      <div style={{ marginBottom: "var(--occ-space-4)" }}>
        ...
        <div style={{
          ...
          {analytics.phases.map((phase) => {
            ...
            return (<div key={phase.phase} style={{
                ...
                <div style={{
                  ...
                  <div style={{ textAlign: "right" }}>
                    ...
                    color: phaseInsight?.status === "on-track"
                        ? "var(--occ-color-success)"
                        : phaseInsight?.status === "at-risk"
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    height: "100%",
                    backgroundColor: phaseInsight?.status === "on-track"
                        ? "var(--occ-color-success)"
                        : phaseInsight?.status === "at-risk"
                            ? "var(--occ-color-warning)"
                            : "var(--occ-color-error)",
...
function PhasesView({ analytics, selectedPhase, onSelectPhase, }) {
    return (<div>
      <h3 style={{ margin: 0, marginBottom: "var(--occ-space-3)" }}>
        Growth Phases
      </h3>
            ...
            return (<div key={phase.phase} style={{
              ...
              <div style={{ marginBottom: "var(--occ-space-3)" }}>
                ...
                <ul style={{ margin: 0, paddingLeft: "var(--occ-space-4)" }}>
                  {phase.objectives.map((objective, index) => (<li key={index} style={{ marginBottom: "var(--occ-space-1)" }}>
                      {objective}
                    </li>))}
                </ul>
              </div>
              ...
              <div style={{ marginBottom: "var(--occ-space-3)" }}>
                ...
                <div style={{ display: "grid", gap: "var(--occ-space-2)" }}>
                  {phase.successCriteria.map((criteria, index) => (<div key={index} style={{
                        display: "flex",
                        justifyContent: "space-between",
                        alignItems: "center",
                      ...
                      <span>
                        {criteria.metric}: {criteria.current}/{criteria.target}
                      </span>
                      <span style={{
                        color: criteria.status === "on-track"
                            ? "var(--occ-color-success)"
                            : criteria.status === "at-risk"
                                ? "var(--occ-color-warning)"
                                : "var(--occ-color-error)",
                        fontSize: "var(--occ-font-size-sm)",
                    }}>
              ...
              {/* Phase Actions */}
              {selectedPhase === phase.phase && (<div>
                  <h5 style={{ margin: 0, marginBottom: "var(--occ-space-2)" }}>
                    Actions ({phaseActions.length}):
                  </h5>
                  <div style={{ display: "grid", gap: "var(--occ-space-2)" }}>
                    {phaseActions.map((action) => (<div key={action.actionId} style={{
                            padding: "var(--occ-space-2)",
                            border: "1px solid var(--occ-border-default)",
                            borderRadius: "var(--occ-radius-sm)",
                            backgroundColor: "var(--occ-bg-subdued)",
                        ...
                        <div style={{
                          ...
                          <div style={{ textAlign: "right" }}>
                            <div style={{
                            color: action.actualROI && action.actualROI > 3
                                ? "var(--occ-color-success)"
...
function ActionsView({ analytics }) {
    return (<div>
      <h3 style={{ margin: 0, marginBottom: "var(--occ-space-3)" }}>
        All Actions
      </h3>
      <div style={{ overflowX: "auto" }}>
        <table style={{
          ...
          <tbody>
            {analytics.actions.map((action) => (<tr key={action.actionId} style={{ borderBottom: "1px solid var(--occ-border-subdued)" }}>
                ...
                backgroundColor: action.priority === "critical"
                    ? "var(--occ-bg-error-subdued)"
                    : action.priority === "high"
                        ? "var(--occ-bg-warning-subdued)"
...
function PerformanceView({ analytics }) {
    return (<div>
      <h3 style={{ margin: 0, marginBottom: "var(--occ-space-3)" }}>
      ...
      <div style={{ marginBottom: "var(--occ-space-4)" }}>
        ...
        <div style={{ display: "grid", gap: "var(--occ-space-2)" }}>
          {analytics.performance.topPerformingActions.map((action) => (<div key={action.actionId} style={{
                padding: "var(--occ-space-3)",
      ...
      <div style={{ marginBottom: "var(--occ-space-4)" }}>
        ...
        <div style={{ display: "grid", gap: "var(--occ-space-2)" }}>
          {analytics.performance.underperformingActions.map((action) => (<div key={action.actionId} style={{
                padding: "var(--occ-space-3)",
      ...
      {/* Critical Actions */}
      {analytics.performance.criticalActions.length > 0 && (<div style={{ marginBottom: "var(--occ-space-4)" }}>
          <h4 style={{ margin: 0, marginBottom: "var(--occ-space-2)" }}>
            Critical Actions
          </h4>
          <div style={{ display: "grid", gap: "var(--occ-space-2)" }}>
            {analytics.performance.criticalActions.map((action) => (<div key={action.actionId} style={{
                    padding: "var(--occ-space-3)",
...
function InsightsView({ analytics }) {
    return (<div>
      ...
      <div style={{ marginBottom: "var(--occ-space-4)" }}>
        ...
        <div style={{ display: "grid", gap: "var(--occ-space-2)" }}>
          {analytics.insights.actionEffectiveness.map((effectiveness) => (<div key={effectiveness.actionType} style={{
                padding: "var(--occ-space-3)",
                border: "1px solid var(--occ-border-default)",
                borderRadius: "var(--occ-radius-md)",
                backgroundColor: "var(--occ-bg-surface)",
              ...
              {effectiveness.recommendations.length > 0 && (<div>
                  <div style={{
                    fontSize: "var(--occ-font-size-sm)",
                    fontWeight: "var(--occ-font-weight-medium)",
                  ...
                  <ul style={{ margin: 0, paddingLeft: "var(--occ-space-4)" }}>
                    {effectiveness.recommendations.map((rec, index) => (<li key={index} style={{ fontSize: "var(--occ-font-size-sm)" }}>
                        {rec}
                      </li>))}
                  </ul>
                </div>)}
      ...
      <div style={{ marginBottom: "var(--occ-space-4)" }}>
        ...
        <div style={{
          ...
          <ul style={{ margin: 0, paddingLeft: "var(--occ-space-4)" }}>
            {analytics.insights.optimizationOpportunities.map((opportunity, index) => (<li key={index} style={{ marginBottom: "var(--occ-space-1)" }}>
                  {opportunity}
                </li>))}
          </ul>
        </div>
      ...
      {/* Risk Factors */}
      {analytics.insights.riskFactors.length > 0 && (<div>
          <h4 style={{ margin: 0, marginBottom: "var(--occ-space-2)" }}>
            Risk Factors
          </h4>
          <div style={{
            ...
            <ul style={{ margin: 0, paddingLeft: "var(--occ-space-4)" }}>
              {analytics.insights.riskFactors.map((risk, index) => (<li key={index} style={{ marginBottom: "var(--occ-space-1)" }}>
                  {risk}
                </li>))}
            </ul>
          </div>
...
function RecommendationsView({ analytics, }) {
    return (<div>
      <h3 style={{ margin: 0, marginBottom: "var(--occ-space-3)" }}>
      ...
      <div style={{ marginBottom: "var(--occ-space-4)" }}>
        ...
        <div style={{
          ...
          <ul style={{ margin: 0, paddingLeft: "var(--occ-space-4)" }}>
            {analytics.recommendations.immediate.map((action, index) => (<li key={index} style={{ marginBottom: "var(--occ-space-1)" }}>
                {action}
              </li>))}
          </ul>
        </div>
      ...
      <div style={{ marginBottom: "var(--occ-space-4)" }}>
        ...
        <div style={{
          ...
          <ul style={{ margin: 0, paddingLeft: "var(--occ-space-4)" }}>
            {analytics.recommendations.shortTerm.map((action, index) => (<li key={index} style={{ marginBottom: "var(--occ-space-1)" }}>
                {action}
              </li>))}
          </ul>
        </div>
      ...
      <div style={{ marginBottom: "var(--occ-space-4)" }}>
        ...
        <div style={{
          ...
          <ul style={{ margin: 0, paddingLeft: "var(--occ-space-4)" }}>
            {analytics.recommendations.longTerm.map((action, index) => (<li key={index} style={{ marginBottom: "var(--occ-space-1)" }}>
                {action}
              </li>))}
          </ul>
        </div>
      ...
      {/* Budget Optimization */}
      {analytics.recommendations.budgetOptimization.length > 0 && (<div>
          <h4 style={{ margin: 0, marginBottom: "var(--occ-space-2)" }}>
            Budget Optimization
          </h4>
          <div style={{ display: "grid", gap: "var(--occ-space-2)" }}>
            {analytics.recommendations.budgetOptimization.map((rec, index) => (<div key={index} style={{
                    padding: "var(--occ-space-3)",
                    border: "1px solid var(--occ-border-default)",
                    borderRadius: "var(--occ-radius-md)",
                    backgroundColor: "var(--occ-bg-surface)",
...
//# sourceMappingURL=GrowthEngineDashboard.js.map