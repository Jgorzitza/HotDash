...
export function SalesPulseTile({ summary, enableModal = false, }) {
    ...
    return (<>
      <div>
        ...
        {enableModal ? (<button type="button" className="occ-link-button" onClick={openModal} data-testid="sales-pulse-open">
            View details
          </button>) : null}
      </div>
      <div>
      ...
      <div>
        ...
        {summary.pendingFulfillment.length ? (<ul style={{
                margin: "var(--occ-space-2) 0 0 0",
                paddingLeft: "1.1rem",
                display: "flex",
                flexDirection: "column",
            ...
            {summary.pendingFulfillment.map((issue) => (<li key={issue.orderId}>
...
//# sourceMappingURL=SalesPulseTile.js.map