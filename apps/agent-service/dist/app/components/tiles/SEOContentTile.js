export function SEOContentTile({ anomalies }) {
    return (<>
      {anomalies.length ? (<ul style={{
                margin: 0,
                paddingLeft: "1.1rem",
                display: "flex",
          ...
          {anomalies.map((anomaly) => (<li key={anomaly.landingPage}>
...
//# sourceMappingURL=SEOContentTile.js.map