...
export function GrowthEngineAnalyticsTile({ analytics, timeframe, period, generatedAt, }) {
    ...
    return (<div style={{ display: "flex", flexDirection: "column", gap: "var(--occ-space-4)" }}>
      {/* Summary Metrics */}
      <div style={{
            display: "grid",
      ...
      <div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--occ-space-2)" }}>
          {analytics.performanceInsights.topPerformingActions.slice(0, 3).map((action) => (<div key={action.actionId} style={{
      ...
      {analytics.performanceInsights.optimizationOpportunities.length > 0 && (<div>
          <h4 style={{
                margin: 0,
                marginBottom: "var(--occ-space-2)",
                fontSize: "var(--occ-font-size-base)",
      ...
      {isExpanded && (<div style={{
          ...
          <div style={{
            ...
            <GrowthEngineAnalyticsComponent analytics={analytics} timeframe={timeframe} period={period} generatedAt={generatedAt}/>
          </div>
        </div>)}
    </div>);
}
//# sourceMappingURL=GrowthEngineAnalyticsTile.js.map