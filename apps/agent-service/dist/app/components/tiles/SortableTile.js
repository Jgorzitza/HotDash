 ...
 */
export function SortableTile({ id, children }) {
    ...
    return (<div ref={setNodeRef} style={style} {...attributes} {...listeners} className="sortable-tile">
      {children}
    </div>);
}
//# sourceMappingURL=SortableTile.js.map