...
export function DevOpsDashboard() {
    ...
    const handleAction = (action, params = {}) => {
        actionFetcher.submit({ action, ...params }, { method: 'post', action: '/api/growth-engine.devops', encType: 'application/json' });
    };
        ...
        <InlineStack gap="400" wrap={false}>
          ...
          <Card>
            ...
            <Box paddingBlockStart="200">
              {status?.automation && (<InlineStack align="space-between" blockAlign="center">
                  <Text as="p" variant="bodyMd">
                    Status: {getStatusBadge(status.automation.status)}
                  </Text>
                  {status.automation.lastDeployment && (<Text as="p" variant="bodySm" color="subdued">
          ...
          <Card>
            ...
            <Box paddingBlockStart="200">
              {status?.performance && (<InlineStack align="space-between" blockAlign="center">
                  <Text as="p" variant="bodyMd">
          ...
          <Card>
            ...
            <Box paddingBlockStart="200">
              {status?.security && (<InlineStack align="space-between" blockAlign="center">
                  <Text as="p" variant="bodyMd">
          ...
          <Card>
            ...
            <Box paddingBlockStart="200">
              {status?.testing && (<InlineStack align="space-between" blockAlign="center">
                  <Text as="p" variant="bodyMd">
...
//# sourceMappingURL=DevOpsDashboard.js.map