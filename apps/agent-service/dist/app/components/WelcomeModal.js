...
import { Modal, BlockStack, InlineStack, Text, Checkbox, ProgressBar, Icon, Badge, } from '@shopify/polaris';
import { FlagIcon, CheckCircleIcon, NotificationIcon, } from '@shopify/polaris-icons';
export function WelcomeModal({ open, onClose, onComplete }) {
    ...
    return (<Modal open={open} onClose={handleClose} title="Welcome to Hot Dash Control Center" size="large" primaryAction={{
      ...
      <Modal.Section>
        <BlockStack gap="500">
          ...
          <BlockStack gap="400" align="center">
            ...
            {currentStepData.id === 'dashboard' && (<BlockStack gap="300">
            ...
            {currentStepData.id === 'approvals' && (<BlockStack gap="300">
            ...
            {currentStepData.id === 'notifications' && (<BlockStack gap="300">
                <InlineStack gap="200" wrap={false}>
          ...
          {isLastStep && (<BlockStack gap="300" align="center">
              <div style={{
          ...
          <Checkbox label="Don't show this welcome tour again" checked={dontShowAgain} onChange={setDontShowAgain}/>

          {/* Step indicators */}
          <InlineStack gap="200" align="center">
            {steps.map((step, index) => (<div key={step.id} style={{
                width: '12px',
                height: '12px',
                borderRadius: '50%',
