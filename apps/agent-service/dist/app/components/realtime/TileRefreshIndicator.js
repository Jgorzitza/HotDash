...
export function TileRefreshIndicator({ lastUpdated, isRefreshing = false, onRefresh, autoRefreshInterval, }) {
    ...
    return (<div style={{
      ...
      {/* Manual refresh button */}
      {onRefresh && (<button onClick={onRefresh} disabled={isRefreshing} style={{
            ...
            }} aria-label="Refresh tile" title="Refresh now">
          <span style={{
...
//# sourceMappingURL=TileRefreshIndicator.js.map