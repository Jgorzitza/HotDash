...
export function ConnectionStatusIndicator({ status, connectionQuality, lastMessage, lastHeartbeat, showDetails = false, size = "medium", }) {
    ...
    return (<div style={{
      ...
      {showDetails && (<div style={{
          ...
          {lastMessage && (<span>Last message: {formatLastMessage()}</span>)}
          {lastHeartbeat && (<span>
