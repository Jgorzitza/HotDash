...
const DoughnutChart = lazy(() => import("../charts/DoughnutChart").then((m) => ({ default: m.DoughnutChart })));
export function AdsROASModal({ data, onClose }) {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <Suspense fallback={<div style={{ height: 300 }}>Loading chart…</div>}>
              <LineChart data={trendChartData} height={300} options={{
            scales: {
                y: {
                    type: "linear",
                    position: "left",
        ...
        <div>
          ...
          <table style={{
            ...
            <tbody>
              {data.campaigns.map((campaign) => (<tr key={campaign.name} style={{ borderBottom: "1px solid var(--occ-border-subtle)" }}>
...
//# sourceMappingURL=AdsROASModal.js.map