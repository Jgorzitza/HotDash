...
export function GrowthMetricsModal({ data, onClose }) {
    ...
    return (<div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <ul style={{
            margin: 0,
            paddingLeft: "var(--occ-space-5)",
            color: "var(--occ-text-secondary)",
        }}>
            {data.weeklyReport.recommendations.map((rec, i) => (<li key={i} style={{ marginBottom: "var(--occ-space-2)" }}>
                {rec}
              </li>))}
          </ul>
        </div>
...
//# sourceMappingURL=GrowthMetricsModal.js.map