 ...
 */
export function setActionKey(actionKey) {
 ...
 */
export function getCurrentActionKey() {
    if (typeof window === 'undefined')
        return null;
 ...
 */
export function clearActionKey() {
    if (typeof window === 'undefined')
        return;
 ...
 */
export function isActionKeyExpired() {
    if (typeof window === 'undefined')
        return true;
 ...
 */
export function calculateCPA(cost, acquisitions) {
    if (acquisitions === 0)
        return 0;
 ...
 */
export function calculateCPC(cost, clicks) {
    if (clicks === 0)
        return 0;
    return cost / clicks;
}
 ...
 */
export function calculateCPM(cost, impressions) {
    if (impressions === 0)
        return 0;
 ...
 */
export function calculatePerformanceScore(conversionRate, averageOrderValue, sessions, revenue) {
 ...
 */
export function calculateAttributionEfficiency(revenue, sessions) {
    if (sessions === 0)
        return 0;
 ...
 */
export function calculateFunnelEfficiency(sessions, pageviews, addToCarts, purchases) {
 ...
 */
export function calculateAttributionConfidence(touchpointCount, conversionRate, dataQuality) {
 ...
 */
export function identifyAttributionPatterns(attributionData) {
    const patterns = [];
    const insights = [];
    const recommendations = [];
    // Analyze peak performance hours
    const peakHours = attributionData.map(d => d.peakPerformanceHour);
    const mostCommonPeakHour = peakHours.reduce((a, b, i, arr) => arr.filter(v => v === a).length >= arr.filter(v => v === b).length ? a : b, 0);
 ...
 */
export function calculateAttributionLift(withAttribution, withoutAttribution) {
 ...
 */
export function validateAttributionData(data) {
    const issues = [];
 ...
 */
export function cleanAttributionData(data) {
    return {
        ...data,
