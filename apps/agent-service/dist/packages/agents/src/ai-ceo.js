...
const shopifyOrders = tool({
    ...
    inputSchema: zodToJsonSchema(ShopifyOrdersSchema, "ShopifyOrdersSchema"),
...
const shopifyProducts = tool({
    ...
    inputSchema: zodToJsonSchema(ShopifyProductsSchema, "ShopifyProductsSchema"),
...
const shopifyCustomers = tool({
    ...
    inputSchema: zodToJsonSchema(ShopifyCustomersSchema, "ShopifyCustomersSchema"),
...
const supabaseAnalytics = tool({
    ...
    inputSchema: zodToJsonSchema(SupabaseAnalyticsSchema, "SupabaseAnalyticsSchema"),
...
const chatwootInsights = tool({
    ...
    inputSchema: zodToJsonSchema(ChatwootInsightsSchema, "ChatwootInsightsSchema"),
...
const llamaIndexQuery = tool({
    ...
    inputSchema: zodToJsonSchema(LlamaIndexSchema, "LlamaIndexSchema"),
...
const googleAnalytics = tool({
    ...
    inputSchema: zodToJsonSchema(GoogleAnalyticsSchema, "GoogleAnalyticsSchema"),
 ...
 */
export async function handleCEOQuery(userQuery) {
 ...
 */
//# sourceMappingURL=ai-ceo.js.map