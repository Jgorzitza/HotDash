...
export class CEOApprovalLearning {
    approvals = [];
    maxHistory = 1000; // Keep last 1000 approvals
    /**
     * Track CEO approval
     */
    async trackApproval(record) {
     ...
     */
    calculateDiff(proposed, approved) {
     ...
     */
    adjustConfidence(originalConfidence, intent) {
...
//# sourceMappingURL=ceo-approval-learning.js.map