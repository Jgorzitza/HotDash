 ...
 */
export declare function getTemplatesByCategory(category: string): ResponseTemplate[];
/**
 ...
 */
export declare function getTemplateById(id: string): ResponseTemplate | undefined;
/**
