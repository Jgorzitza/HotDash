...
const taskData = {
  ...
  acceptanceCriteria: process.env.CRITERIA ? process.env.CRITERIA.split('|') : ['Complete as described'],
...
console.log(`  npx tsx --env-file=.env scripts/agent/get-my-tasks.ts ${taskData.assignedTo}`);
