...
async function ensureTask(task: NewTask) {
  try {
    ...
    if (
      err?.code === "P2002" ||
      /Unique constraint/.test(String(err?.message))
    ) {
...
async function main() {
  console.log(
    "Assigning vision gap tasks from COMPLETE_VISION_OVERVIEW / PROJECT_PLAN ...",
  );
  ...
  const tasks: NewTask[] = [
    ...
    // Phase 4: Notification System (P1)
    {
      ...
      acceptanceCriteria: [
        "Global toast utility implemented",
        "Approval actions show toasts",
      ],
      allowedPaths: ["app/**"],
      priority: "P1",
      estimatedHours: 1,
    ...
    },
    {
      ...
      acceptanceCriteria: [
        ...
        "Notification fires on new approval",
      ],
      allowedPaths: ["app/**"],
      priority: "P1",
      estimatedHours: 1,
    ...
    // Phase 6: Settings Page (P2)
    {
      ...
      description:
        "Tabbed settings for Dashboard, Appearance, Notifications, Integrations.",
      acceptanceCriteria: [
        "Tabbed layout works",
        "Form saves to user_preferences",
      ],
    ...
    // Phase 8: Data Visualization (P2)
    {
      ...
      description:
        "Integrate @shopify/polaris-viz and add sparklines, bar/line/donut charts.",
    ...
    // Phase 9: Onboarding (P3)
    {
      ...
      description:
        "Design and implement welcome modal and 4-step tooltip tour.",
      acceptanceCriteria: [
        "Welcome modal first-visit only",
        "Tour navigates 4 steps",
      ],
    ...
    // Phase 10: Approval History & Audit (P2)
    {
      ...
      description:
        "Filterable table with search and CSV export; timeline view.",
      acceptanceCriteria: [
        "Filters work",
        "CSV export works",
    ...
    // Phase 11: Polish & Refinements (P2)
    {
      ...
      description:
        "Complete tokens, docs, and implement dark mode palette with toggle.",
    ...
    },
    {
      ...
      description:
        "Run accessibility audit and log findings; verify keyboard and SR support.",
      acceptanceCriteria: [
        "Report produced",
        "Critical issues resolved or tracked",
      ],
    ...
    // Data layer tasks for missing tables
    {
      ...
      description:
        "Add Supabase table for personalization (tile order, visibility, theme, notification_prefs).",
      acceptanceCriteria: [
    ...
    },
    {
      ...
      description:
        "Add notifications table with read/unread and priority levels.",
    ...
    },
    {
      ...
      description:
        "Add approval_queue table and enable Supabase Realtime for queue updates.",
    ...
    },
    {
      ...
      description:
        "Persist Sales Pulse modal actions and notes with audit trail.",
    ...
    },
    {
      ...
      description:
        "Persist Inventory modal reorder approvals and vendor selections.",
      acceptanceCriteria: ["Table created", "Basic service layer available"],
      allowedPaths: [
        "supabase/migrations/**",
        "prisma/schema.prisma",
